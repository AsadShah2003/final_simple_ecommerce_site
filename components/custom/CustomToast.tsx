...
const Toast: React.FC<ToastProps> = ({ type, message, duration = 3000, onClose }) => {
    ...
    return (
        <div
            className={`${roboto.className} flex items-center gap-2 fixed top-4  left-[40%] text-sm text max-w-[400px] w-full ${styles} text-center p-4 rounded-md border border-gray-200 z-50 animate-toast-in-out`}
        >
            {
                type === "success" ?
